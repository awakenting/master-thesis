...
for cax, m_val in zip([ax1, ax2], [1, 2]):
    ...
    for tau_m in tau_m_values:
        ...
        for i in np.arange(nruns):
            resp_angle, resp_dist, resp_time, lv, stim_size, speed, resp_time_coll = md.calc_response_stationary_inh(params)
...
#plt.show()
plt.savefig(os.path.join(figure_path, 'figure_station_inh_resp_angle.pdf'), bbox_inches='tight')
