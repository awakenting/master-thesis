...
\begin{document}
	...
	We assume that the timescale of the Input is much higher that the timescale 
	of the neuronal dynamics so that we have a the following stationary process:
	\begin{equation}
	...
	\begin{equation}
	10^{7} I(t) - c_{\rho} 10^{7} I(t) - \rho_{0} \overset{!}{=} 0.018
	\end{equation}

	\begin{equation}
	10^{-4} c_{exc} f(\theta(t)) (1 - c_{\rho}) - \rho_{0} \overset{!}{=} 0.018
	\end{equation}
	
	\begin{equation}
	f(\theta(t)) \overset{!}{=} \frac{180 + \rho_{0}10^{4}} 
	{c_{exc}(1 - c_{\rho})}
	\end{equation}

	\begin{equation}
	\theta(t) \overset{!}{=} \frac{180 + \rho_{0}10^{4}} 
